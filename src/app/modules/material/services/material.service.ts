...
export class MaterialService extends CrudService<Material> implements IServiceCommon {

  @Output() eventFormComponent: EventEmitter<ModalFormComponent> = new EventEmitter();
  @Output() eventTableComponent: EventEmitter<GenericTableComponent<Material>> = new EventEmitter();
  ...
  constructor(
    ...
    super(http, `${environment.server_url}/materials`, httpErrorHandlerService);
  }
