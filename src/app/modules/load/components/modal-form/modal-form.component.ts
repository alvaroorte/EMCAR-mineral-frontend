...
import { TypeMaterialService } from 'src/app/modules/type-material/services/type-material.service';
...
export class ModalFormComponent {
  ...
  private waitForDataSelection() {
    this.loadService.getSelectedRow().subscribe((Load) => this.selectedLoad = Load);
  }
