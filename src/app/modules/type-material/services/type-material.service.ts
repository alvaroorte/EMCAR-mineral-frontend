...
export class TypeMaterialService extends CrudService<TypeMaterial> implements IServiceCommon {

  @Output() eventFormComponent: EventEmitter<ModalFormComponent> = new EventEmitter();
  @Output() eventTableComponent: EventEmitter<GenericTableComponent<TypeMaterial>> = new EventEmitter();
  ...
  constructor(
    ...
    super(http, `${environment.server_url}/typeMaterials`, httpErrorHandlerService);
  }
